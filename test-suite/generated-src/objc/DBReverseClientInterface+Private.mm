...
- (id)initWithCpp:(const std::shared_ptr<::ReverseClientInterface>&)cppRef;

@end

@implementation DBReverseClientInterface {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::ReverseClientInterface>> _cppRefHandle;
}
...
+ (nullable DBReverseClientInterface *)create {
    try {
        auto objcpp_result_ = ::ReverseClientInterface::create();
