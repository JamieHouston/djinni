...
::testsuite::ClientReturnedRecord ClientReturnedRecord::toCpp() {
    return ::testsuite::ClientReturnedRecord(
        ...
        transform<std::experimental::optional<std::string>, Platform::IBox<Platform::String>^>()(Misc));
}
...
ClientReturnedRecord^ ClientReturnedRecord::fromCpp(const ::testsuite::ClientReturnedRecord& value) {
    ...
    ret->Misc = transform<std::experimental::optional<std::string>, Platform::IBox<Platform::String>^>()(value.misc);
    return ret;
}
