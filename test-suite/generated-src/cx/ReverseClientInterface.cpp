...
{
    try {
        auto cppRet = _cppRef->meth_taking_interface(transform<std::shared_ptr<::ReverseClientInterface>, ::testsuite::ReverseClientInterface^>()(I));
        return transform<std::string, Platform::String^>()(cppRet);
    }
    catch(const std::exception& e) {
        throw ref new Platform::Exception(-1, transform<std::string, Platform::String^>()((std::string)e.what()));
...
{
    try {
        auto cppRet = _cppRef->meth_taking_optional_interface(transform<std::shared_ptr<::ReverseClientInterface>, ::testsuite::ReverseClientInterface^>()(I));
        return transform<std::string, Platform::String^>()(cppRet);
    }
    catch(const std::exception& e) {
        throw ref new Platform::Exception(-1, transform<std::string, Platform::String^>()((std::string)e.what()));
...
{
    try {
        auto cppRet = _cppRef->meth_taking_and_returning_record_list(transform<std::vector<::ClientReturnedRecord>, Windows::Foundation::Collections::IVector<::testsuite::ClientReturnedRecord^>^>()(Rl));
        return transform<std::vector<::ClientReturnedRecord>, Windows::Foundation::Collections::IVector<::testsuite::ClientReturnedRecord^>^>()(cppRet);
    }
    catch(const std::exception& e) {
        throw ref new Platform::Exception(-1, transform<std::string, Platform::String^>()((std::string)e.what()));
    }
...
{
    try {
        auto cppRet = ::ReverseClientInterface::create();
        return transform<std::shared_ptr<::ReverseClientInterface>, ::testsuite::ReverseClientInterface^>()(cppRet);
    }
    catch(const std::exception& e) {
        throw ref new Platform::Exception(-1, transform<std::string, Platform::String^>()((std::string)e.what()));
    }
