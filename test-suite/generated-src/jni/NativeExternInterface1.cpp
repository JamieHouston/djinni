...
CJNIEXPORT ::djinni_generated::NativeClientReturnedRecord::JniType JNICALL Java_com_dropbox_djinni_test_ExternInterface1_00024CppProxy_native_1methTakingRecordList(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_lr)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ExternInterface1>(nativeRef);
        auto r = ref->meth_taking_record_list(::djinni::List<::djinni_generated::NativeClientReturnedRecord>::toCpp(jniEnv, j_lr));
        return ::djinni::release(::djinni_generated::NativeClientReturnedRecord::fromCpp(jniEnv, r));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, 0 /* value doesn't matter */)
}

CJNIEXPORT jobject JNICALL Java_com_dropbox_djinni_test_ExternInterface1_00024CppProxy_native_1methReturningRecordList(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, ::djinni_generated::NativeClientReturnedRecord::JniType j_r)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ExternInterface1>(nativeRef);
        auto r = ref->meth_returning_record_list(::djinni_generated::NativeClientReturnedRecord::toCpp(jniEnv, j_r));
